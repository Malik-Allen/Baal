...
//    {
//        auto vertShaderCode = readFile( "./Engine/Graphics/Shaders/vert.spv" );
//        auto fragShaderCode = readFile( "./Engine/Graphics/Shaders/frag.spv" );
//
...
//                if( index.vertex_index >= 0 && index.vertex_index * 3 + 2 < attrib.vertices.size() )
//                {
//                    vertex.pos = {
